...
class BaseModel(BaseModule):
    ...
    def test_step(self, data: Union[dict, tuple, list], *args, **kwargs) -> list:
        ...
        # !!!!!!!!!!!!!!!!
        data = self.data_preprocessor(data, False)
        return self._run_forward(data, want_label, mode='predict')  # type: ignore
    ...
    def _run_forward(self, data: Union[dict, tuple, list],
        ...
        if want_label != []:
            if 0 in want_label:
                data['inputs'][0, 0, 0] = -1.8044
            if 1 in want_label:
                data['inputs'][0, 0, 1] = -1.0898
            if 2 in want_label:
                data['inputs'][0, 0, 2] = -0.7238
            if 3 in want_label:
                data['inputs'][0, 0, 3] = -0.6541
            else:
                want_label = []
        # !!!!!!!!!!!!!!!!!!!!!!!
