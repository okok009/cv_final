...
# 讓want_label 以外的像素變0 (line: 380-383), 讓bbox 不見 (line: 136), 讓text 不見 (line: 154)
    ...
    def add_datasample(
        ...
        if draw_pred and data_sample is not None:
            ...
            if 'pred_instances' in data_sample:
                ...
                pred_img_data = pred_img_data - image
                image = image_matting(pred_img_data, image)
                pred_img_data = image
