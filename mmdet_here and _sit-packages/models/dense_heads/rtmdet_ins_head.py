...
class RTMDetInsHead(RTMDetHead):
    ...
    def _predict_by_feat_single(self,
        ...
        for level_idx, (cls_score, bbox_pred, kernel_pred,
            ...
            # 對已經經過kernel_conv 後的輸出(80, 80, 256) permute 成 (80, 80, 169) 再reshape 成 (-1, 169)，-1只自動填充。 ------> 做flatten 然後保持169 channel -----> (6400, 169), (1600, 169), (400, 169)
